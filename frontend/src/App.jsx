    ...
    if (isRecording) {
      ...
      try {
        ...
        recorder.onstop = async () => {
          ...
          // wait 300ms for final chunks to flush
          await new Promise(r => setTimeout(r, 300))
          const blob = new Blob(audioChunksRef.current, { type: "audio/webm" })
          console.log("Recording blob size:", blob.size, "chunks:", audioChunksRef.current.length)
          if (blob.size < 500) {
            alert("Recording too short or empty. Please speak for at least 2 seconds.")
            setIsRecording(false)
            setSending(false)
            setTyping(false)
      ...
      <div className="chatArea">
        ...
        {isRecording && (
          <div className="recordingOverlay">
            ...
            <div className="recordingLabel">🔴 Recording... click mic to stop</div>
          </div>
        )}
